(defproject em "0.1.0-SNAPSHOT"
  ...
  :npm {:dependencies [["create-react-class" "15.7.0"]
                       ["react" "17.0.2"]
                       ["react-dom" "17.0.2"]
                       ["font-awesome" "4.2.0"]
                       ["shadow-cljs" "2.19.9"]
  ...
  :shadow-cljs {:builds
                {:app {:target     :browser
                       :output-dir "../sites/brokerage/assets"
                       :asset-path "../sites/brokerage/assets"
                       :modules    {:everleighmonaco {:entries [em.app]}}
                       :devtools   {:watch-dir "..sites/brokerage/assets"
  ...
  :garden {:builds [{:id           "screen"
                     ...
                     :compiler     {:output-to     "../sites/brokerage/css/everleighmonaco.css"
                                    :pretty-print? true}}]}
